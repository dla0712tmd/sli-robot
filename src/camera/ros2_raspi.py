...
class VisionNode(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Detection2DArray, 'detection_topic', 10)
            ...
            while True:
                ...
                try:
                    ...
                    for detection in detections:
                        ...
                        distance, rate_area, horizontal_direction, vertical_direction = self.calculate_distance_and_direction(rounded_bbox, (image_width, image_height))
    ...
    def calculate_distance_and_direction(self, bbox, image_dimensions):
        x1, y1, x2, y2 = bbox
        center_x = (x1 + x2) / 2
        center_y = (y1 + y2) / 2
